"""
Enhanced backtesting engine package with tick data support.
...
* [**Tick-Based Backtesting Guide**](../TICK_BACKTESTING.md)
...
# Import from original backtesting engine
from .backtesting import Backtest, Strategy

# Import tick-based enhancements  
from .tick_backtesting import TickBacktest, run_tick_backtest, create_sample_tick_data

# Import enhanced utilities
from .tick_util import _EnhancedData, _Array, _Indicator
